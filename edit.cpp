...
void Edit::draw() {
	...
	// inner blob
	render::gradient(p.x + EDIT_X_OFFSET + 1, p.y + 15 + 1, m_w - EDIT_X_OFFSET - 2, EDIT_BOX_HEIGHT - 2, { 30, 30, 30, m_parent->m_alpha }, { 45, 45, 45, m_parent->m_alpha }, false);

	// box outline.
	render::rect(p.x + EDIT_X_OFFSET, p.y + 15, m_w - EDIT_X_OFFSET, EDIT_BOX_HEIGHT, { 11, 11, 11, m_parent->m_alpha });
