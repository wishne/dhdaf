...
public:
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_rgflCoordinateFrame;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_iMoveState;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_hViewModel;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_nAnimationParity;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flDetectedByEnemySensorTime;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flGuardianTooFarDistFrac;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flWeaponCycle;
    ...
    void init( ) {
        ...
        INIT_XOREDNETVAR( m_flGuardianTooFarDistFrac,   HASH( "DT_CSPlayer" ),             HASH( "m_flGuardianTooFarDistFrac" ) );
        INIT_XOREDNETVAR( m_flDetectedByEnemySensorTime,HASH( "DT_CSPlayer" ),             HASH( "m_flDetectedByEnemySensorTime" ) );
        INIT_XOREDNETVAR( m_nAnimationParity,           HASH( "DT_PredictedViewModel" ),   HASH( "m_nAnimationParity" ));
        ...
        INIT_XOREDNETVAR( m_iMoveState,                 HASH( "DT_CSPlayer" ),             HASH( "m_iMoveState" ) );
        INIT_XOREDNETVAR( m_vecVelocity,                HASH( "DT_BasePlayer" ),           HASH( "m_vecVelocity[0]" ) );
        ...
        INIT_XOREDNETVAR( m_bClientSideAnimation,       HASH( "DT_BaseAnimating" ),             HASH( "m_bClientSideAnimation" ) );
        ...
        INIT_XOREDNETVAR_SPECIFIC( m_rgflCoordinateFrame,        g_netvars.get( HASH( "DT_BaseEntity" ),        HASH( "m_CollisionGroup" ) ) - 0x30 );
        ...
        INIT_XOREDNETVAR_SPECIFIC( m_flWeaponCycle, 0xA14 );
