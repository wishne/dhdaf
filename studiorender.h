...
public:
	...
	vfunc(10, SetVectorInternal(const float x, const float y), void(__thiscall*)(void*, float, float))(x, y)
		vfunc(11, SetVectorInternal(const float x, const float y, const float z), void(__thiscall*)(void*, float, float, float))(x, y, z)
};
...
public:
	...
	virtual void* GetPreviewImageProperties(int* width, int* height, void* imageFormat, bool* isTranslucent) const = 0;
	virtual void* GetPreviewImage(unsigned char* data, int width, int height, void* imageFormat) const = 0;
