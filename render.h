...
namespace render {
	...
	extern Font override;
	extern Font arrows;
	extern Font menu_icons1;

	void triangle(vec2_t point_one, vec2_t point_two, vec2_t point_three, Color color, bool arrow);
	...
	void gradientind(int x, int y, int w, int h, Color color1, Color color2);
	...
	void rect_filled_round(vec2_t pos, vec2_t size, int points, int radius, Color col);
